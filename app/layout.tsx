...
export const metadata: Metadata = {
  ...
  keywords: ['loft insulation', 'home insulation', 'energy efficiency', 'thermal insulation', 'roof insulation', 'attic insulation'],
  ...
  twitter: {
    ...
    title: 'Loft Insulation Solutions | Energy Efficient Home Insulation',
    description: 'Professional loft insulation services to reduce energy bills and improve home comfort.',
